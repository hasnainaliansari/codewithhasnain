...
const reviewList = [
  {
    ...
    review: `Working with Hasnain was a smooth experience. He built our web app using React and PHP exactly the way we envisioned it. Very professional and easy to communicate with.`,
  ...
  },
  {
    ...
    review: `Our e-commerce site now runs faster and more securely thanks to Hasnain's expertise in JavaScript and backend integration. Definitely recommended for any serious dev work.`,
    stars: [<StarFill className="ratting fz-20" />],
  },
  {
    id: 3,
    name: "Nathan Jr",
    position: "App Founder",
    review: `He developed our cross-platform mobile app using Flutter and integrated Firebase smoothly. From UI to backend – handled everything efficiently.`,
    stars: [<StarFill className="ratting fz-20" />],
  },
];
